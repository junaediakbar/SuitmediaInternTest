package com.juned.expertclass.sutimediainterntest.ui.adapter
...
import com.juned.expertclass.sutimediainterntest.databinding.ItemListUserBinding

class ListUsersAdapter(
    private val onClick: (String) -> Unit
) : PagingDataAdapter<UserDataResponse, ListUsersAdapter.ListUsersViewHolder>(DIFF_CALLBACK) {
